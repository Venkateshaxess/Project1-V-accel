            ...
            <div className='row g-5'>
                ...
                <div className='col-md-8 d-flex flex-column justify-content-around'>
                    <div data-aos='fade-up' data-aos-duration='600'>
                        <p className='secondary-text'>Devnio, a premier software development firm, excels in crafting bespoke enterprise solutions tailored to your company's unique requirements. Beyond mere technical expertise, we embody visionary creativity, adept at turning potential into tangible achievements.</p>
