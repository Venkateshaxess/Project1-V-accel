...
// //       src={logo} 
// //       alt="Logo" 
// //       style={{ width: '200px', height: '220px', objectFit: 'contain' }} 
// //     />
// //   </Link>
// // </div>
...
//     <div>
//       {/* Upper Navigation */}
//       <div className='d-flex justify-content-between bg-white align-items-center border-bottom container-fluid flex-wrap px-3' data-aos='fade-down' data-aos-duration='500'>
...
//       {/* Main Navigation */}
//       <nav className={`navbar w-100 navbar-expand-lg bg-body-tertiary px-0 z-3 ${fixed || ''}`}>
//         <div className="container-fluid px-3">
//           {/* Mobile Top */}
//           <div className="d-lg-none d-flex justify-content-between align-items-center w-100 py-2">
//             <Link to='/' className="navbar-brand m-0 p-0">
//               <img src={vlogo} alt="Mobile Logo" style={{ height: '50px' }} />
//             </Link>
//             <p className="m-0 fw-bold" onClick={() => navigation("/")}>Devnivo</p>
//             <button
//               className={`navbar-toggler shadow-none border-0 hamburger hamburger--spring-r ${nav ? 'is-active' : ''}`}
//               type="button"
//               data-bs-toggle="collapse"
...
//           {/* Navigation Links */}
//           <div className="collapse navbar-collapse" id="navbarSupportedContent">
//             <ul className="navbar-nav align-items-center mx-auto mb-2 mb-lg-0 gap-3" data-aos='fade-up'>
//               <li className="nav-item">
//                 <NavLink to='/' className="nav-link navhover">Home</NavLink>
//               </li>
//               <li className="nav-item">
//                 <NavLink to="/about" className="nav-link navhover">Team</NavLink>
//               </li>
//               <li className="nav-item position-relative">
//                 <NavLink to='/services' className="nav-link navhover" onClick={() => setValue(true)}>
//                   Services
//                 </NavLink>
//                 <div className="drop">
...
//       <div className='d-none d-lg-flex justify-content-between align-items-center border-bottom px-3' style={{ height: '100px' }}>
//         <div className="d-flex align-items-center">
//           <Link to='/' className="navbar-brand m-0 p-0">
//             <img
//               src={logo}
...
//             <Link to='/' className="navbar-brand m-0 p-0">
//               <img src={vlogo} alt="Mobile Logo" style={{ height: '40px' }} />
//             </Link>
//             <p className="m-0 fw-bold" onClick={() => navigation("/")}>Devnivo</p>
//             <button
