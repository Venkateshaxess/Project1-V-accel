    ...
    return (
        <div className='container'>
            <div className="technstack_wrapper text-center">
                ...
                <p className='secondary-text mb-5 col-lg-10 mx-auto' data-aos='fade-right' data-aos-duration='600'>Forget deciphering tech speak and navigating the ever-evolving landscape.Devnio, we speak plain English and deliver powerful results. Our team of passionate tech whizzes are masters of their craft, constantly honing their skills to stay ahead of the curve.
